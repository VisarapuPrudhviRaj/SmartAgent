...
public class UnCaughtException implements UncaughtExceptionHandler {
    ...
    public UnCaughtException(Context context, String appName) {
    ...
    public void sendErrorMail(final StringBuilder errorContent) {
        sendMail(errorContent);
    }

    private void sendMail(final StringBuilder errorContent) {
        Intent sendIntent = new Intent(
                Intent.ACTION_SEND);
        String subject = "Your " + appName + " App crashed! Fix it!";
        StringBuilder body = new StringBuilder(appName);
        body.append('\n').append('\n');
        ...
        sendIntent.putExtra(Intent.EXTRA_EMAIL,
                new String[]{"prudhvirajvisarapu@gmail.com"});
        sendIntent.putExtra(Intent.EXTRA_TEXT,
                body.toString());
        sendIntent.putExtra(Intent.EXTRA_SUBJECT,
                subject);
        sendIntent.setType("message/rfc822");
        Intent chooser = Intent.createChooser(sendIntent, "Send Crash Report To Mail");
